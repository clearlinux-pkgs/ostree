...
Version  : 2022.6
Release  : 54
URL      : https://github.com/ostreedev/ostree/releases/download/v2022.6/libostree-2022.6.tar.xz
Source0  : https://github.com/ostreedev/ostree/releases/download/v2022.6/libostree-2022.6.tar.xz
...
%prep
%setup -q -n libostree-2022.6
cd %{_builddir}/libostree-2022.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665506873
