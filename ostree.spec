...
Source0  : https://github.com/ostreedev/ostree/releases/download/v2022.4/libostree-2022.4.tar.xz
...
%prep
%setup -q -n libostree-2022.4
cd %{_builddir}/libostree-2022.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656455969
...
cp %{_builddir}/libostree-2022.4/COPYING %{buildroot}/usr/share/package-licenses/ostree/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/libostree-2022.4/bsdiff/LICENSE %{buildroot}/usr/share/package-licenses/ostree/4ee6d2132726e5074e6917e113cf34d3cf625ce2
cp %{_builddir}/libostree-2022.4/libglnx/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ostree/5c6c38fa1b6ac7c66252c83d1203e997ae3d1c98
cp %{_builddir}/libostree-2022.4/libglnx/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/ostree/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
