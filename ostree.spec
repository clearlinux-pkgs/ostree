...
Source0  : https://github.com/ostreedev/ostree/releases/download/v2023.7/libostree-2023.7.tar.xz
...
%prep
%setup -q -n libostree-2023.7
cd %{_builddir}/libostree-2023.7
pushd ..
cp -a libostree-2023.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698017446
