...
Version  : 2023.2
Release  : 57
URL      : https://github.com/ostreedev/ostree/releases/download/v2023.2/libostree-2023.2.tar.xz
Source0  : https://github.com/ostreedev/ostree/releases/download/v2023.2/libostree-2023.2.tar.xz
...
%prep
%setup -q -n libostree-2023.2
cd %{_builddir}/libostree-2023.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680727247
