...
Version  : 2023.1
Release  : 56
URL      : https://github.com/ostreedev/ostree/releases/download/v2023.1/libostree-2023.1.tar.xz
Source0  : https://github.com/ostreedev/ostree/releases/download/v2023.1/libostree-2023.1.tar.xz
...
%prep
%setup -q -n libostree-2023.1
cd %{_builddir}/libostree-2023.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677008453
