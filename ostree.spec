...
# autospec commit: 53fe209
#
Name     : ostree
Version  : 2024.5
Release  : 71
URL      : https://github.com/ostreedev/ostree/releases/download/v2024.5/libostree-2024.5.tar.xz
Source0  : https://github.com/ostreedev/ostree/releases/download/v2024.5/libostree-2024.5.tar.xz
...
Patch1: backport-fix-curl-callback.patch
...
%prep
%setup -q -n libostree-2024.5
cd %{_builddir}/libostree-2024.5
%patch -P 1 -p1
pushd ..
cp -a libostree-2024.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726702849
...
/usr/share/man/man1/ostree-admin-lock-finalization.1
/usr/share/man/man1/ostree-admin-os-init.1
/usr/share/man/man1/ostree-admin-pin.1
/usr/share/man/man1/ostree-admin-post-copy.1
...
/usr/share/man/man8/ostree-state-overlay@.service.8
