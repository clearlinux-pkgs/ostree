...
Source0  : https://github.com/ostreedev/ostree/releases/download/v2024.4/libostree-2024.4.tar.xz
...
%prep
%setup -q -n libostree-2024.4
cd %{_builddir}/libostree-2024.4
pushd ..
cp -a libostree-2024.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708966373
