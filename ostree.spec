...
Version  : 2022.3
Release  : 50
URL      : https://github.com/ostreedev/ostree/releases/download/v2022.3/libostree-2022.3.tar.xz
Source0  : https://github.com/ostreedev/ostree/releases/download/v2022.3/libostree-2022.3.tar.xz
...
%prep
%setup -q -n libostree-2022.3
cd %{_builddir}/libostree-2022.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651879131
...
cp %{_builddir}/libostree-2022.3/COPYING %{buildroot}/usr/share/package-licenses/ostree/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/libostree-2022.3/bsdiff/LICENSE %{buildroot}/usr/share/package-licenses/ostree/4ee6d2132726e5074e6917e113cf34d3cf625ce2
cp %{_builddir}/libostree-2022.3/libglnx/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ostree/5c6c38fa1b6ac7c66252c83d1203e997ae3d1c98
cp %{_builddir}/libostree-2022.3/libglnx/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/ostree/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
