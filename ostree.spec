...
Source0  : https://github.com/ostreedev/ostree/releases/download/v2022.7/libostree-2022.7.tar.xz
...
%prep
%setup -q -n libostree-2022.7
cd %{_builddir}/libostree-2022.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669944303
